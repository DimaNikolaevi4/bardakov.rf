...
class com_phocapdfInstallerScript
{
    ...
    protected $extension 	= 'com_phocapdf';
    protected $updatetext 	= 'COM_PHOCAPDF_UPDATE_TEXT';
    protected $installtext 	= 'COM_PHOCAPDF_INSTALL_TEXT';
    protected $versiontext	= 'COM_PHOCAPDF_VERSION';
    protected $extensiontext= 'COM_PHOCAPDF';
    protected $configuretext= 'COM_PHOCAPDF_CONFIGURE';
    ...
    */
	...
	function renameBak(&$sccFile, &$errFile, $fontName = 'freemono') {
		...
		if (file_exists($rsrc) && !file_exists($rdest)) {
			...
			//$errFile[] = $error . Text::_( 'COM_PHOCAPDF_ERROR_FILE_NOT_EXIST' ). ': ' . str_replace( JPATH_ROOT . '/', '', $rsrc);
			//$errFile[] = $error . Text::_( 'COM_PHOCAPDF_ERROR_FILE_EXIST' ). ': ' . $rdest;
		}
