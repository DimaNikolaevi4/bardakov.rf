...
$upEL = 'https://extensions.joomla.org/extension/phoca-pdf/';
$upE = 'Phoca PDF';
...
echo '<div class="ph-cp-btn-update"><a class="btn btn-large btn-info" href="https://www.phoca.cz/phocapdf-plugins" target="_blank"><i class="icon-share icon-white"></i>&nbsp;&nbsp;'.  Text::_($this->t['l'] . '_CHECK_FOR_AVAILABLE_PLUGINS') .'</a></div>';

echo '<div class="ph-cp-btn-update"><a class="btn btn-large btn-info" href="https://www.phoca.cz/phocapdf-fonts" target="_blank"><i class="icon-share icon-white"></i>&nbsp;&nbsp;'.  Text::_($this->t['l'] . '_CHECK_FOR_AVAILABLE_FONTS') .'</a></div>';
