<?php die("Access Denied"); ?>#x#a:2:{s:4:"body";s:63361:"                        <!DOCTYPE html>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<link href="/templates/rt_elixir/custom/css-compiled/elixir_20.css?6a0787d8" rel="stylesheet">
	<link href="/media/gantry5/engines/nucleus/css-compiled/bootstrap5.css" rel="stylesheet">
	<link href="/media/system/css/joomla-fontawesome.min.css" rel="stylesheet">
	<link href="/media/plg_system_debug/css/debug.css" rel="stylesheet">
	<link href="/media/gantry5/assets/css/font-awesome6-pseudo.min.css" rel="stylesheet">
	<link href="/templates/rt_elixir/custom/css-compiled/elixir-joomla_20.css?6a0787d9" rel="stylesheet">
    ...
    <script type="application/json" class="joomla-script-options new">{"joomla.jtext":{"MOD_FINDER_SEARCH_VALUE":"Введите текст...","COM_FINDER_SEARCH_FORM_LIST_LABEL":"Результаты поиска","JLIB_JS_AJAX_ERROR_OTHER":"При получении данных JSON произошла ошибка. Код состояния HTTP %s.","JLIB_JS_AJAX_ERROR_PARSE":"При обработке данных JSON произошла ошибка парсинга:<br><code style=\"color:inherit;white-space:pre-wrap;padding:0;margin:0;border:0;background:inherit;\">%s<\/code>","JLIB_FORM_CONTAINS_INVALID_FIELDS":"Не удалось отправить форму, так как одно или несколько полей заполнено некорректно.","JLIB_FORM_FIELD_REQUIRED_VALUE":"Пожалуйста, заполните поле","JLIB_FORM_FIELD_REQUIRED_CHECK":"Пожалуйста, выберите значение","JLIB_FORM_FIELD_INVALID_VALUE":"Пожалуйста, введите корректное значение"},"finder-search":{"url":"\/component\/finder\/?task=suggestions.suggest&format=json&tmpl=component&Itemid=132"},"system.paths":{"root":"","rootFull":"https:\/\/www.xn--80aabgi1b2am.xn--p1ai\/","base":"","baseFull":"https:\/\/www.xn--80aabgi1b2am.xn--p1ai\/"},"csrf.token":"3112864643f7de372dc283b07dee9ab9","system.keepalive":{"interval":840000,"uri":"\/component\/ajax\/?format=json"},"accessibility-options":{"labels":{"menuTitle":"Панель доступности","increaseText":"Увеличить размер шрифта","decreaseText":"Уменьшить размер шрифта","increaseTextSpacing":"Увеличить интервал шрифта","decreaseTextSpacing":"Уменьшить интервал шрифта","invertColors":"Инвертировать цвета","grayHues":"Серые оттенки","underlineLinks":"Подчеркнуть ссылки","bigCursor":"Увеличить курсор","readingGuide":"Линейка для чтения","textToSpeech":"Преобразовать текст в речь","speechToText":"Преобразовать речь в текст","resetTitle":"Сбросить","closeTitle":"Закрыть"},"icon":{"position":{"left":{"size":"0","units":"px"}},"useEmojis":false},"hotkeys":{"enabled":true,"helpTitles":true},"textToSpeechLang":["ru-RU"],"speechToTextLang":["ru-RU"]},"plg_system_schedulerunner":{"interval":300}}</script>
	...
	<script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"https://www.xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base","name":"Преподаватель Бардаков","url":"https://www.xn--80aabgi1b2am.xn--p1ai/"},{"@type":"WebSite","@id":"https://www.xn--80aabgi1b2am.xn--p1ai/#/schema/WebSite/base","url":"https://www.xn--80aabgi1b2am.xn--p1ai/","name":"Преподаватель Бардаков","publisher":{"@id":"https://www.xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base"},"potentialAction":{"@type":"SearchAction","target":"https://www.xn--80aabgi1b2am.xn--p1ai/search?q={search_term_string}","query-input":"required name=search_term_string"}},{"@type":"WebPage","@id":"https://www.xn--80aabgi1b2am.xn--p1ai/#/schema/WebPage/base","url":"https://www.xn--80aabgi1b2am.xn--p1ai/obo-mne/kontakty","name":"Контакты","isPartOf":{"@id":"https://www.xn--80aabgi1b2am.xn--p1ai/#/schema/WebSite/base"},"about":{"@id":"https://www.xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base"},"inLanguage":"ru-RU"},{"@type":"Person","@id":"https://www.xn--80aabgi1b2am.xn--p1ai/#/schema/com_contact/contact/1","name":"Бардаков Дмитрий Николаевич","jobTitle":"преподаватель","address":{"streetAddress":"График работы: пн-пт 8:00-16:00, сб 08:00-12:00. Выходной воскресенье\r\nул. Ленина, д. 27,","addressLocality":"Сальск","addressRegion":"Ростовская область","postalCode":"347630","url":"https://xn--80aabgi1b2am.xn--p1ai"},"isPartOf":{"@id":"https://www.xn--80aabgi1b2am.xn--p1ai/#/schema/WebPage/base"}}]}</script>
...
<!-- /Yandex.Metrika counter -->
<link rel="canonical" href="https://бардаков.рф/obo-mne/kontakty" />
</head>


    <body class="gantry site com_contact view-contact no-layout no-task dir-ltr itemid-155 outline-20 g-offcanvas-left g-default g-style-preset3">
...
<div id="system-message-container">
    ...
    <form class="mod-finder js-finder-searchform form-search" action="/search" method="get" aria-label="search">
        ...
        <div class="g-block size-100 button button-3">
             <div class="g-content">
                                    <div id="module-custom-163-particle" class="g-particle"><h1>Контакты</h1>
<p style="text-align: justify;">Уважать всякого человека, как самого себя, и поступать с ним, как мы желаем, чтобы с нами поступали, — выше этого нет ничего.</p>
<p style="text-align: right;"><em>Конфуций</em></p></div>
        ...
        <div id="module-flipster-211" data-flipster-id="module-flipster-211" data-flipster-start="center" data-flipster-fadein="400" data-flipster-loop="false" data-flipster-autoplay="false" data-flipster-pauseonhover="true" data-flipster-style="coverflow" data-flipster-spacing="-0.2" data-flipster-click="true" data-flipster-keyboard="true" data-flipster-scrollwheel="false"  data-flipster-touch="true" class="g-flipster">
            <div class="g-flipster-cards">
                            ...
                            <div class="g-flipster-card-container ">
                                        ...
                                        Моя цель - передача знаний и развитие умений студентов, если Вы знаете как сделать лучше - напишите мне.
                                    </div>
                            ...
                            <div class="g-flipster-card-container g-flipster-card-image">
                                                                    <img src="/images/banners/img002.png" alt="gantry-media://banners/img002.png" />
                                                            </div>
                        </div>
                                            <div class="g-flipster-card g-flipster-card-accent-accent2" >
                            <div class="g-flipster-card-container ">
                                                                    <div class="g-flipster-description">
                                        Я ощущаю удовлетворение от того, что помогаю своим студентам, нужна помощь - напиши мне.
                                    </div>
                                    <div class="g-flipster-title">
        ...
        <div class="g-block size-100">
            ...
            <h1>
                                <span class="contact-name">Бардаков Дмитрий Николаевич</span>
            </h1>
        </div>
            ...
            <dt>
                        ...
                        <span class="jicons-icons visually-hidden">Адрес: </span>
        </dt>

                    <dd>
                <span class="contact-street">
                    График работы: пн-пт 8:00-16:00, сб 08:00-12:00. Выходной воскресенье<br>
ул. Ленина, д. 27,                </span>
            </dd>
    ...
    <dt>
                ...
                <span class="jicons-icons visually-hidden">Сайт: </span>
    </dt>
    <dd>
        <span class="contact-webpage">
            <a href="https://xn--80aabgi1b2am.xn--p1ai" target="_blank" rel="noopener noreferrer">
            https://бардаков.рф</a>
        </span>
    </dd>
</dl>
    ...
    <form id="contact-form" action="/obo-mne/kontakty" method="post" class="form-validate form-horizontal well">
                                                            <fieldset class="m-0">
    ...
    Текст<span class="star" aria-hidden="true">&#160;*</span></label>
</div>
        <div class="controls">
        <textarea name="jform[contact_message]" id="jform_contact_message"  cols="50"  rows="10" class="form-control required"       required       ></textarea>            </div>
            ...
            <div class="controls">
                ...
                <input type="hidden" name="id" value="1:bardakov-dmitrij-nikolaevich">
                <input type="hidden" name="3112864643f7de372dc283b07dee9ab9" value="1">            </div>
        </div>
    </form>
</div>
