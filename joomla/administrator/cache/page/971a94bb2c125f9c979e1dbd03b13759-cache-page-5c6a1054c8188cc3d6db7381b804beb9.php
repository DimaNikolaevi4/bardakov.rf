<?php die("Access Denied"); ?>#x#a:2:{s:4:"body";s:74842:"                    <!DOCTYPE html>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<link href="/templates/rt_elixir/custom/css-compiled/elixir_26.css?69ce0550" rel="stylesheet">
	<link href="/media/gantry5/engines/nucleus/css-compiled/bootstrap5.css" rel="stylesheet">
	<link href="/media/system/css/joomla-fontawesome.min.css" rel="stylesheet">
	<link href="/media/plg_system_debug/css/debug.css" rel="stylesheet">
	<link href="/media/gantry5/assets/css/font-awesome6-pseudo.min.css" rel="stylesheet">
	<link href="/templates/rt_elixir/custom/css-compiled/elixir-joomla_26.css?69ce0551" rel="stylesheet">
    ...
    <script type="application/json" class="joomla-script-options new">{"highlight":[{"class":"js-highlight","highLight":["практическая","1"]}],"joomla.jtext":{"MOD_FINDER_SEARCH_VALUE":"Введите текст...","COM_FINDER_SEARCH_FORM_LIST_LABEL":"Результаты поиска","JLIB_JS_AJAX_ERROR_OTHER":"При получении данных JSON произошла ошибка. Код состояния HTTP %s.","JLIB_JS_AJAX_ERROR_PARSE":"При обработке данных JSON произошла ошибка парсинга:<br><code style=\"color:inherit;white-space:pre-wrap;padding:0;margin:0;border:0;background:inherit;\">%s<\/code>"},"finder-search":{"url":"\/component\/finder\/?task=suggestions.suggest&format=json&tmpl=component&Itemid=132"},"system.paths":{"root":"","rootFull":"https:\/\/xn--80aabgi1b2am.xn--p1ai\/","base":"","baseFull":"https:\/\/xn--80aabgi1b2am.xn--p1ai\/"},"csrf.token":"cfcc87995ca7882ad9e574e7009673a6","accessibility-options":{"labels":{"menuTitle":"Панель доступности","increaseText":"Увеличить размер шрифта","decreaseText":"Уменьшить размер шрифта","increaseTextSpacing":"Увеличить интервал шрифта","decreaseTextSpacing":"Уменьшить интервал шрифта","invertColors":"Инвертировать цвета","grayHues":"Серые оттенки","underlineLinks":"Подчеркнуть ссылки","bigCursor":"Увеличить курсор","readingGuide":"Линейка для чтения","textToSpeech":"Преобразовать текст в речь","speechToText":"Преобразовать речь в текст","resetTitle":"Сбросить","closeTitle":"Закрыть"},"icon":{"position":{"left":{"size":"0","units":"px"}},"useEmojis":false},"hotkeys":{"enabled":true,"helpTitles":true},"textToSpeechLang":["ru-RU"],"speechToTextLang":["ru-RU"]}}</script>
...
<!-- /Yandex.Metrika counter -->
<link rel="canonical" href="https://бардаков.рф/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no1?highlight=WyJcdTA0M2ZcdTA0NDBcdTA0MzBcdTA0M2FcdTA0NDJcdTA0MzhcdTA0NDdcdTA0MzVcdTA0NDFcdTA0M2FcdTA0MzBcdTA0NGYiLDFd" />
</head>
