<?php die("Access Denied"); ?>#x#a:2:{s:4:"body";s:111699:"                    <!DOCTYPE html>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<link href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur?view=category&amp;id=2&amp;format=feed&amp;type=rss" rel="alternate" type="application/rss+xml" title="Uncategorised">
	<link href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur?view=category&amp;id=2&amp;format=feed&amp;type=atom" rel="alternate" type="application/atom+xml" title="Uncategorised">
	...
	<link href="/templates/rt_elixir/custom/css-compiled/elixir_20.css?69c70fc1" rel="stylesheet">
	<link href="/media/gantry5/engines/nucleus/css-compiled/bootstrap5.css" rel="stylesheet">
	<link href="/media/system/css/joomla-fontawesome.min.css" rel="stylesheet">
	<link href="/media/plg_system_debug/css/debug.css" rel="stylesheet">
	<link href="/media/gantry5/assets/css/font-awesome6-pseudo.min.css" rel="stylesheet">
	<link href="/templates/rt_elixir/custom/css-compiled/elixir-joomla_20.css?69c70fc2" rel="stylesheet">
...
<!-- /Yandex.Metrika counter -->
<link rel="canonical" href="https://бардаков.рф/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur?id=2&amp;view=category" />
</head>


    <body class="gantry site com_content view-category no-layout no-task dir-ltr itemid-310 outline-20 g-offcanvas-left g-default g-style-preset3">
...
<div class="item-content">
    ...
    <span class="icon-folder-open icon-fw" aria-hidden="true"></span>                        Категория: <a href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur?view=category&amp;id=2">Uncategorised</a>    </dd>
...
<p>Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые администратором сайта https://Бардаков.рф (далее — Оператор).</p>
<p>1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.</p>
<p>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://бардаков.рф.</p>
<h5>2. Основные понятия, используемые в Политике</h5>
<p>2.1. Автоматизированная обработка персональных данных — обработка персональных данных с помощью средств вычислительной техники.</p>
<p>2.2. Блокирование персональных данных — временное прекращение обработки персональных данных (за исключением случаев, если обработка необходима для уточнения персональных данных).</p>
<p>2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://бардаков.рф.</p>
...
<p>2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://бардаков.рф.</p>
<p>2.9. Персональные данные, разрешенные субъектом персональных данных для распространения, — персональные данные, доступ неограниченного круга лиц к которым предоставлен субъектом персональных данных путем дачи согласия на обработку персональных данных, разрешенных субъектом персональных данных для распространения в порядке, предусмотренном Законом о персональных данных (далее — персональные данные, разрешенные для распространения).</p>
<p>2.10. Пользователь — любой посетитель веб-сайта https://бардаков.рф.</p>
...
<p>8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора <joomla-hidden-mail  is-link="1" is-email="1" first="cHJpdmF0ZQ==" last="0LHQsNGA0LTQsNC60L7Qsi7RgNGE" text="cHJpdmF0ZUDQsdCw0YDQtNCw0LrQvtCyLtGA0YQ=" base="" >Адрес электронной почты защищен от спам-ботов. Для просмотра адреса в браузере должен быть включен Javascript.</joomla-hidden-mail> с пометкой «Актуализация персональных данных».</p>
<p>8.4. Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные, если иной срок не предусмотрен договором или действующим законодательством.<br>Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора <joomla-hidden-mail  is-link="1" is-email="1" first="cHJpdmF0ZQ==" last="0LHQsNGA0LTQsNC60L7Qsi7RgNGE" text="cHJpdmF0ZUDQsdCw0YDQtNCw0LrQvtCyLtGA0YQ=" base="" >Адрес электронной почты защищен от спам-ботов. Для просмотра адреса в браузере должен быть включен Javascript.</joomla-hidden-mail> с пометкой «Отзыв согласия на обработку персональных данных».</p>
...
<p>12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <joomla-hidden-mail  is-link="1" is-email="1" first="cHJpdmF0ZTE=" last="0LHQsNGA0LTQsNC60L7Qsi7RgNGE" text="cHJpdmF0ZTFA0LHQsNGA0LTQsNC60L7Qsi7RgNGE" base="" >Адрес электронной почты защищен от спам-ботов. Для просмотра адреса в браузере должен быть включен Javascript.</joomla-hidden-mail>.</p>
...
<p>12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://бардаков.рф/private.</p>
...
<div class="item-content">
        ...
        <div class="page-header">
                    <h2>
                                    <a href="/abiturientu/spetsialnosti/ekonomika-i-bukhgalterskij-uchet-po-otraslyam">
...
<div class="item-content">
        ...
        <div class="page-header">
                    <h2>
                                    <a href="/abiturientu/spetsialnosti/kompyuternye-sistemy-i-kompleksy">
                        09.02.01 Компьютерные системы и комплексы                    </a>
                            </h2>
...
<div class="item-content">
        ...
        <div class="page-header">
                    <h2>
                                    <a href="/abiturientu/professii/15-01-31-master-kontrolno-izmeritelnykh-priborov-i-avtomatiki">
                        15.01.31 Мастер контрольно-измерительных приборов и автоматики                    </a>
                            </h2>
...
<li><strong>Срок обучения:</strong>   На базе 9 класса - 3 года 10 месяцев</li>
<li><strong>Форма обучения:</strong>    Очная</li>
<li><strong>Будущая квалификация:</strong>    Слесарь по контрольно-измерительным приборам и автоматике</li>
<li><strong><strong>Будущие профессии: </strong></strong>Слесарь КИПиА <strong><strong> </strong></strong></li>
</ul>
<h4 style="text-align: center;"><strong><strong>Чему научат?</strong></strong></h4>
<ul>
<li>Монтировать схемы управления систем автоматики в соответствии с требованиями охраны труда и экологической безопасности;</li>
<li>Выполнять наладку электрических схем и приборов автоматики в соответствии с требованиями технической документации;</li>
<li>Техническому обслуживанию и эксплуатации приборов и систем автоматики в соответствии с регламентом, требованиями охраны труда, бережливого производства и экологической безопасности</li>
</ul>
...
<ol class="com-content-blog__links">
            ...
            <a href="/abiturientu/professii/13-01-10-elektromonter-po-remontu-i-obsluzhivaniyu-elektrooborudovaniya-po-otraslyam">
                13.01.10 Электромонтер по ремонту и обслуживанию электрооборудования (по отраслям)</a>
        </li>
            <li class="com-content-blog__link">
            <a href="/abiturientu/professii/15-01-05-svarshchik-ruchnoj-i-chastichno-mekhanizirovannoj-svarki-naplavki">
                15.01.05 Сварщик ручной и частично механизированной сварки (наплавки)</a>
        </li>
            <li class="com-content-blog__link">
            <a href="/abiturientu/professii/43-01-09-povar-konditer">
                43.01.09 Повар, кондитер</a>
        </li>
            <li class="com-content-blog__link">
            <a href="/abiturientu/professii/08-01-07-master-obshchestroitelnykh-rabot">
                08.01.07 Мастер общестроительных работ</a>
        </li>
    </ol>
        </div>
    ...
    <ul class="pagination ms-0 mb-4">
        ...
        <a aria-current="true" aria-label="Страница 1" href="#" class="page-link">1</a>
                        ...
                        <li class="page-item">
        <a aria-label="Перейти на 2" href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur?view=category&amp;id=2&amp;start=10" class="page-link">
            2        </a>
    </li>
        
            <li class="page-item">
        <a aria-label="Перейти на следующую страницу" href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur?view=category&amp;id=2&amp;start=10" class="page-link">
            <span class="icon-angle-right" aria-hidden="true"></span>        </a>
    </li>
            <li class="page-item">
        <a aria-label="Перейти на последнюю страницу" href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur?view=category&amp;id=2&amp;start=10" class="page-link">
