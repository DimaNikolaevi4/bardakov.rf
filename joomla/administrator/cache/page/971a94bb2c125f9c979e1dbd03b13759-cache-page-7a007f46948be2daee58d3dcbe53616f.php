<?php die("Access Denied"); ?>#x#a:2:{s:4:"body";s:124742:"                    <!DOCTYPE html>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
         ...
         <meta charset="utf-8">
	<meta name="description" content="2 обязательным">
	...
	<link href="/search?q=2&amp;format=feed&amp;type=rss" rel="alternate" type="application/rss+xml" title="Search">
	<link href="/search?q=2&amp;format=feed&amp;type=atom" rel="alternate" type="application/atom+xml" title="Search">
	...
	<link href="/templates/rt_elixir/custom/css-compiled/elixir_20.css?6a0ac68a" rel="stylesheet">
	<link href="/media/gantry5/engines/nucleus/css-compiled/bootstrap5.css" rel="stylesheet">
	<link href="/media/system/css/joomla-fontawesome.min.css" rel="stylesheet">
	<link href="/media/plg_system_debug/css/debug.css" rel="stylesheet">
	<link href="/media/gantry5/assets/css/font-awesome6-pseudo.min.css" rel="stylesheet">
	<link href="/templates/rt_elixir/custom/css-compiled/elixir-joomla_20.css?6a0ac68b" rel="stylesheet">
...
<!-- /Yandex.Metrika counter -->
<link rel="canonical" href="https://бардаков.рф/index.php/search?q=2" />
</head>


    <body class="gantry site com_finder view-search no-layout no-task dir-ltr itemid-115 outline-20 g-offcanvas-left g-default g-style-preset3">
...
<div id="system-message-container">
    ...
    <form class="mod-finder js-finder-searchform form-search" action="/search?q=2" method="get" aria-label="search">
        <label for="mod-finder-searchword204" class="visually-hidden finder">Поиск</label><input type="text" name="q" id="mod-finder-searchword204" class="js-finder-search-query form-control" value="2" placeholder="Введите текст...">
                            </form>
</search></div>
...
<form action="/search?q=2" method="get" class="js-finder-searchform">
        ...
        <div class="form-inline">
            ...
            <div class="input-group">
                <input type="text" name="q" id="q" class="js-finder-search-query form-control" value="2">
...
<div class="field-calendar">
	...
	<option value="39">Все</option>
                ...
                <div id="search-query-explained" class="com-finder__explained">
                                        <p role="alert">
                Предполагая слово <span class="query-required"><span class="term">2</span> обязательным</span>, найдено <a href="#search-result-list">22 элемента</a>.            </p>
            </div>
    <ul id="search-result-list" class="js-highlight com-finder__results-list" start="1">
                                        <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no1?highlight=WzJd" class="result__title-link"><span class="result__title-text">Практическая работа №1</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no1</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-09-24T14:13:57+00:00">
                    24 сентября 2023                </time>
                        непосредственно в земле. В качестве искусственных заземлителей используют стальные трубы длиной 1,5…4 м, диаметром 25…50 мм, которые забивают в землю, а также металлические стержни и полосы. Для достижения требуемого сопротивления заземлителя, как...        </p>
                    <ul class="result__taxonomy">
                            ...
                            <span>Автор:</span>
                            Бардаков Дмитрий Николаевич                        </li>
                            ...
                            Практические КИП                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no9?highlight=WzJd" class="result__title-link"><span class="result__title-text">Практическая работа №9</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no9</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-09-24T14:13:57+00:00">
                    24 сентября 2023                </time>
                        при аварии на химически опасном объекте - АО «НПП «Исток» Характеристика химически опасного объекта: соляная кислота 12-14 т (в единичной емкости 1,5 т); численность персонала 4900 человек; емкости с соляной кислотой расположены на площадке, огороженной...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Практические КИП                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no4?highlight=WzJd" class="result__title-link"><span class="result__title-text">Практическая работа №4</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no4</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-09-24T14:13:57+00:00">
                    24 сентября 2023                </time>
                        световых проемов при боковом освещении производится по следующей зависимости: ; (1) где S0 – площадь световых проемов, м2; Sn – площадь помещения, м2; ен – нормативное значение коэффициентов естественной освещенности (КЕО); Кз – коэффициент запаса на...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Практические КИП                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/kniga-roni-terram-poludnitsa/kniga-roni-terram-poludnitsa-2?highlight=WzJd" class="result__title-link"><span class="result__title-text">Глава 2</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/kniga-roni-terram-poludnitsa/kniga-roni-terram-poludnitsa-2</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-01-05T11:05:08+00:00">
                    05 января 2023                </time>
                        Глава 2 Раздался трель будильника. Открыв один глаз, я потянулась за телефоном, автоматически выключая звон. 6:30 Еще целых два часа до школы, которые я проведу с пользой. Как же это раздражает. Несмотря на то, что основным орудием теней являются наши...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Бардаков Дмитрий Николаевич                        </li>
                                                                                                                                                                                                                                                                                    <li class="result__taxonomy-item result__taxonomy--Category">
                            <span>Категория:</span>
                            Книга Roni Terram «Полудница»                        </li>
                                                                                            </ul>
    </li>
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no8?highlight=WzJd" class="result__title-link"><span class="result__title-text">Практическая работа №8</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no8</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-09-24T14:13:57+00:00">
                    24 сентября 2023                </time>
                        причиненного его здоровью или имуществу экологическим правонарушением, закреплено в Конституции Российской Федерации [1]. 2017 год Президент РФ объявилВ целях привлечения внимания общества к вопросам экологического развития Российской Федерации,...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Практические КИП                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur-2?highlight=WzJd" class="result__title-link"><span class="result__title-text">Работа в действующих установках, находящихся под давлением и в зоне высоких температур</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur-2</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2024-09-17T05:22:51+00:00">
                    17 сентября 2024                </time>
                        1. Установки под давлением Установки, в которых давление превышает атмосферное. Примеры: котлы, реакторы и компрессоры. 2. Температурный режим Диапазон температур, при котором оборудование функционирует. Важно учитывать максимальные и минимальные...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Бардаков Дмитрий Николаевич                        </li>
                                                                                                                                                                                                                                                                                    <li class="result__taxonomy-item result__taxonomy--Category">
                            <span>Категория:</span>
                            Тема 1.1 Организация работ по монтажу систем автоматизации                         </li>
                                                                                            </ul>
    </li>
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/naladka-mikroprotsessornogo-modulya-vvoda-analogovykh-signalov-na-primere-izmeritelnoj-sistemy-temperatury?highlight=WzJd" class="result__title-link"><span class="result__title-text">Наладка и калибровка микропроцессорного модуля ввода аналоговых сигналов в измерительной системе температуры</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/naladka-mikroprotsessornogo-modulya-vvoda-analogovykh-signalov-na-primere-izmeritelnoj-sistemy-temperatury</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2025-10-25T06:21:22+00:00">
                    25 октября 2025                </time>
                        а также последовательность операций по настройке и калибровке микропроцессорного модуля ввода аналоговых сигналов. 2. Понятие измерительной системы и роль калибровки Измерительная система представляет собой комплекс технических средств, программного...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Тема 1.1 Организация работ по монтажу систем автоматизации                         </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no2?highlight=WzJd" class="result__title-link"><span class="result__title-text">Практическая работа №2</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no2</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-09-24T14:13:57+00:00">
                    24 сентября 2023                </time>
                        циклоны Предназначены для улавливания сухой пыли и золы. Наиболее эффективно циклоны работают при размерах частиц пыли более 20 мкм. Конические циклоны предназначены для очистки газовых и воздушных сред от сажистых частиц. Производительность циклона...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Практические КИП                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/component/tags/tag/millions?highlight=WzJd" class="result__title-link"><span class="result__title-text">Millions</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/component/tags/tag/millions</cite></a>            </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Тег                        </li>
                            ...
                            преподаватель                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no7?highlight=WzJd" class="result__title-link"><span class="result__title-text">Практическая работа №7</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no7</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-09-24T14:13:57+00:00">
                    24 сентября 2023                </time>
                        в Красную книгу Ростовской области. Красная книга Ростовской области имеет уже 15-летнюю историю. Первое издание выпущено в 2004 году, второе было презентовано в 2014. Если первоначальный вариант содержал на своих страницах 579 биологических таксонов,...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Практические КИП                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no6?highlight=WzJd" class="result__title-link"><span class="result__title-text">Практическая работа №6</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no6</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-09-24T14:13:57+00:00">
                    24 сентября 2023                </time>
                        и учета несчастных случаев на производстве. Описать несчастные случаи, которые подлежат расследованию и учету. Задание № 2. Ознакомиться с обязанностями работодателя у которого произошѐл несчастный случай, порядком расследования несчастного случая....        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Практические КИП                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no5?highlight=WzJd" class="result__title-link"><span class="result__title-text">Практическая работа №5</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no5</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-09-24T14:13:57+00:00">
                    24 сентября 2023                </time>
                        /1/. Тогда как одной из разновидностей техногенных рисков в области охраны труда также является профессиональный риск /2/, который связан с профессиональной деятельностью и является результатом действия комплекса различного рода причин: технологических,...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Практические КИП                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/abiturientu/dokumentatsiya?highlight=WzJd" class="result__title-link"><span class="result__title-text">Документация</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/abiturientu/dokumentatsiya</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2022-10-23T17:22:52+00:00">
                    23 октября 2022                </time>
                        проводится по личному заявлению граждан. При подаче заявления о приеме поступающий предъявляет следующие документы: 1. Паспорт 2. Ксерокопия паспорта 3. Документ об образовании (с твердой обложкой) 4. Ксерокопия документа об образовании 5. 4 фотографий...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Uncategorised                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur?highlight=WzJd" class="result__title-link"><span class="result__title-text">Работа в действующих установках, находящихся под давлением и в зоне высоких температур</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2024-09-17T05:23:38+00:00">
                    17 сентября 2024                </time>
                        1. Установки под давлением Установки, в которых давление превышает атмосферное. Примеры: котлы, реакторы и компрессоры. 2. Температурный режим Диапазон температур, при котором оборудование функционирует. Важно учитывать максимальные и минимальные...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
        ...
        <p class="result__title">
                    <a href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur?highlight=WzJd" class="result__title-link"><span class="result__title-text">Работа в действующих установках, находящихся под давлением и в зоне высоких температур</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/rabota-v-dejstvuyushchikh-ustanovkakh-nakhodyashchikhsya-pod-davleniem-i-v-zone-vysokikh-temperatur</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2024-09-17T05:20:29+00:00">
                    17 сентября 2024                </time>
                        1. Установки под давлением Установки, в которых давление превышает атмосферное. Примеры: котлы, реакторы и компрессоры. 2. Температурный режим Диапазон температур, при котором оборудование функционирует. Важно учитывать максимальные и минимальные...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            ...
                            Тема 1.1 Организация работ по монтажу систем автоматизации                         </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no3?highlight=WzJd" class="result__title-link"><span class="result__title-text">Практическая работа №3</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no3</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-09-24T14:13:57+00:00">
                    24 сентября 2023                </time>
                        практические навыки определения опасных и вредных производственных факторов на рабочем месте. Нормативная правовая база: ГОСТ 12.0.003 — 74 «ССБТ. Опасные и вредные производственные факторы» ГОСТ 12.1.007-76 «ССБТ. Вредные вещества, классификация и...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Практические КИП                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/private?highlight=WzJd" class="result__title-link"><span class="result__title-text">Политика в отношении обработки персональных данных</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/private</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-09-11T17:44:52+00:00">
                    11 сентября 2023                </time>
                        положения Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Uncategorised                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/podgotovka-k-proizvodstvu-montazhnykh-rabot?highlight=WzJd" class="result__title-link"><span class="result__title-text">Подготовка к производству монтажных работ</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii/podgotovka-k-proizvodstvu-montazhnykh-rabot</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2023-01-05T11:05:08+00:00">
                    05 января 2023                </time>
                        работ показан на рисунке: Рис. 1. Фрагмент схемы такелажно-транспортных работ (подъем щитов КИП на отметку + 7200) 1 — щит. 2 — канат. 3,4 — стропы. 5 — лебедка. 6 — блок. 7 — площадка котла. В зависимости от сложности объекта ППР может быть выполнен в...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Тема 1.1 Организация работ по монтажу систем автоматизации                         </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/abiturientu/professii/15-01-05-svarshchik-ruchnoj-i-chastichno-mekhanizirovannoj-svarki-naplavki?highlight=WzJd" class="result__title-link"><span class="result__title-text">15.01.05 Сварщик ручной и частично механизированной сварки (наплавки)</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/abiturientu/professii/15-01-05-svarshchik-ruchnoj-i-chastichno-mekhanizirovannoj-svarki-naplavki</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2022-10-25T09:13:36+00:00">
                    25 октября 2022                </time>
                        Срок обучения: На базе 9 класса - 2 месяца 10 месяцев Форма обучения: Очная Будущая квалификация: Сварщик частично механизированной сварки плавлением | Сварщик ручной дуговой сварки плавящим покрытым электродом Будущие профессии: Газорезчик |...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Uncategorised                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/abiturientu/professii/08-01-07-master-obshchestroitelnykh-rabot?highlight=WzJd" class="result__title-link"><span class="result__title-text">08.01.07 Мастер общестроительных работ</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/abiturientu/professii/08-01-07-master-obshchestroitelnykh-rabot</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2022-10-25T09:10:27+00:00">
                    25 октября 2022                </time>
                        Срок обучения: На базе 9 класса - 2 года 10 месяцев Форма обучения: Очная Будущая квалификация: Каменщик | Электросварщик ручной сварки Будущие профессии: Арматурщик | Бетонщик | Каменщик | Монтажник по монтажу стальных и железобетонных конструкций |...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Uncategorised                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/abiturientu/professii/13-01-10-elektromonter-po-remontu-i-obsluzhivaniyu-elektrooborudovaniya-po-otraslyam?highlight=WzJd" class="result__title-link"><span class="result__title-text">13.01.10 Электромонтер по ремонту и обслуживанию электрооборудования (по отраслям)</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/abiturientu/professii/13-01-10-elektromonter-po-remontu-i-obsluzhivaniyu-elektrooborudovaniya-po-otraslyam</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2022-10-25T09:14:31+00:00">
                    25 октября 2022                </time>
                        Срок обучения: На базе 9 класса - 2 года 10 месяцев Форма обучения: Очная Будущая квалификация: Электромонтер по ремонту и обслуживанию электрооборудования Будущие профессии: Электромонтер по ремонту и обслуживанию электрооборудования Чему научат?...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
                            ...
                            Uncategorised                        </li>
                                    ...
                                    <li class="result__item">
        <p class="result__title">
                    <a href="/abiturientu/professii/prodavets-kontroler-kassir?highlight=WzJd" class="result__title-link"><span class="result__title-text">38.01.02 Продавец, контролер-кассир</span><cite class="result__title-url">https://xn--80aabgi1b2am.xn--p1ai/abiturientu/professii/prodavets-kontroler-kassir</cite></a>            </p>
            <p class="result__description">
                            <time class="result__date" datetime="2022-10-23T17:51:10+00:00">
                    23 октября 2022                </time>
                        Срок обучения: На базе 9 класса - 2 года 10 месяцев Форма обучения: Очная Будущая квалификация: Контролер-кассир | Продавец непродовольственных товаров | Продавец продовольственных товаров Будущие профессии: Кассир торгового зала | Контролер-кассир |...        </p>
                    <ul class="result__taxonomy">
                                                                                                                                                                                                                                                <li class="result__taxonomy-item result__taxonomy--Type">
                            <span>Тип:</span>
                            Материал                        </li>
...
<div class="com-finder__navigation search-pagination">
        <div class="com-finder__pagination w-100">
                ...
                <div class="com-finder__counter search-pages-counter">
                                                                        Показано <strong>1</strong> - <strong>22</strong> из <strong>22</strong>        </div>
    </div>
        </div>
    </div></div></div></div>
