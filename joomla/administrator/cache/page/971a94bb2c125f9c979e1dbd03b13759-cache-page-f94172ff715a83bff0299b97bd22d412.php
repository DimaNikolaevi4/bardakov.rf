<?php die("Access Denied"); ?>#x#a:2:{s:4:"body";s:64316:"                    <!DOCTYPE html>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<link href="/templates/rt_elixir/custom/css-compiled/elixir_26.css?69d16da1" rel="stylesheet">
	<link href="/media/gantry5/engines/nucleus/css-compiled/bootstrap5.css" rel="stylesheet">
	<link href="/media/system/css/joomla-fontawesome.min.css" rel="stylesheet">
	<link href="/media/plg_system_debug/css/debug.css" rel="stylesheet">
	<link href="/media/gantry5/assets/css/font-awesome6-pseudo.min.css" rel="stylesheet">
	<link href="/templates/rt_elixir/custom/css-compiled/elixir-joomla_26.css?69d16da2" rel="stylesheet">
	...
	<script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base","name":"Преподаватель Бардаков","url":"https://xn--80aabgi1b2am.xn--p1ai/"},{"@type":"WebSite","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebSite/base","url":"https://xn--80aabgi1b2am.xn--p1ai/","name":"Преподаватель Бардаков","publisher":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base"},"potentialAction":{"@type":"SearchAction","target":"https://xn--80aabgi1b2am.xn--p1ai/search?q={search_term_string}","query-input":"required name=search_term_string"}},{"@type":"WebPage","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebPage/base","url":"https://xn--80aabgi1b2am.xn--p1ai/index.php/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no2?ysclid=mnkrait826801664698","name":"Практическая работа №2","isPartOf":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebSite/base"},"about":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base"},"inLanguage":"ru-RU"},{"@type":"Article","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/com_content/article/34","name":"Практическая работа №2","headline":"Практическая работа №2","inLanguage":"ru-RU","author":{"@type":"Person","name":"Бардаков Дмитрий Николаевич"},"isPartOf":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebPage/base"}}]}</script>
...
<!-- /Yandex.Metrika counter -->
<link rel="canonical" href="https://бардаков.рф/index.php/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no2?ysclid=mnkrait826801664698" />
</head>
...
<div id="system-message-container">
    ...
    <span class="icon-user icon-fw" aria-hidden="true"></span>
        ...
        <p><strong>Тема: </strong>Расчёт аппаратуры для защиты атмосферного воздуха от промышленных загрязнений.</p>
<p><strong>Цель работы:</strong> Освоить расчёт аппаратуры для защиты атмосферного воздуха от промышленных загрязнений.</p>
 
<ol>
<li><strong> Расчёт аппаратуры для защиты атмосферы от промышленных загрязнений</strong></li>
</ol>
<p>Различные производственные процессы могут загрязнять атмосферный воздух взвешенными твердыми или жидкими частицами, которые делятся на пыль, дым и туман. Для улавливания взвешенных частиц применяется различная аппаратура, в составе которой значительное место занимают циклонные аппараты, являющиеся наиболее распространенной аппаратурой для сухого механического пылеулавливания. Данное практическое занятие включает в себя расчет и оценку эффективности различных типов циклонных аппаратов.</p>
<ol start="2">
<li><strong> Цилиндрические циклоны</strong></li>
</ol>
<p>Предназначены для улавливания сухой пыли и золы. Наиболее эффективно циклоны работают при размерах частиц пыли более 20 мкм. Конические циклоны предназначены для очистки газовых и воздушных сред от сажистых частиц. Производительность циклона увеличивается с ростом его диаметра. Для расчета циклона необходимо выбрать тип циклона в зависимости от вида взвешенных частиц и их размера. Задавшись типом циклона, определяют оптимальную скорость W<sub>опт</sub>.</p>
<p>Т.к. размер частиц силикозоопысные пылей d&lt;8 мкм, то выбираем циклон конический СК-ЦН-34, оптимальная скорость W<sub>опт</sub>=1,7 м/с</p>
<p>Определяем диаметр цикл она по формуле:</p>
<p><br /><img style="display: block; margin-left: auto; margin-right: auto;" src="/images/prakt/kip/1.png" alt="" /></p>
<p> где <strong>D</strong> – диаметр циклона, м;</p>
<p><strong>Q</strong> – производительность циклона, м<sup>3</sup>/с;</p>
<p><strong>W</strong><strong><sub>опт</sub></strong> - оптимальная скорость, м/с.</p>
<p style="text-align: center;"> <img src="/images/prakt/kip/2.png" alt="" /></p>
<p>В соответствии с типом циклона по его диаметру определяют геометрические размеры циклона.</p>
<p>Полученное значение диаметра округляют до ближайшего типового значения в соответствии с рядом и все расчеты геометрических размеров ведут по типовому значению D. Если расчетный диаметр циклона превышает его максимально-допустимое значение, то необходимо применять два или более параллельно установленных циклона. Принимаем D=0,9 м.</p>
<p>По выбранному диаметру циклона определяют действительную скорость газа в циклоне по формуле:</p>
<p style="text-align: center;"> <img src="/images/prakt/kip/3.png" alt="" /></p>
<p>где <strong>W</strong> – действительная скорость газа, м/с;</p>
<p><strong>n</strong> – число циклонов (n=1) </p>
<p> <img style="display: block; margin-left: auto; margin-right: auto;" src="/images/prakt/kip/4.png" alt="" /></p>
<p>Действительная скорость не должна отличаться от оптимальной более чем на 15%. Отличие составляет 3%.</p>
<p>Для проведения оценки эффективности очистки газов в циклоне сначала необходимо рассчитать диаметр частиц по формуле:</p>
<p> <img style="display: block; margin-left: auto; margin-right: auto;" src="/images/prakt/kip/5.png" alt="" /></p>
<p>где <strong>d</strong><strong><sub>50</sub></strong> – диаметр частиц, улавливаемых с эффективностью 50%, мкм;</p>
<p><strong>d</strong><strong><sup>Т</sup></strong><strong><sub>50</sub></strong> – диаметр частиц, улавливаемых с эффективностью 50% для типового циклона (см. табл. 2), мкм (d<sup>Т</sup><sub>50</sub> = 1,95 мкм);</p>
<p><strong>D</strong> – диаметр циклона, м (D=0,9 м);</p>
<p><strong>D</strong><strong><sup>Т</sup></strong> – диаметр типового циклона (D = 0.6 м);</p>
<p><strong>r</strong> – плотность частиц, кг/м<sup>3</sup> (ρ = 1910 кг/м<sup>3</sup>);</p>
<p><strong>r</strong><strong><sup>Т</sup></strong> – плотность частиц для типового циклона (r = 1930 кг/м<sup>3</sup>).</p>
<p><strong>m</strong> – вязкость газа, Н×с/м<sup>2</sup> (μ = 22.1×10<sup>-6</sup> Н×с/м<sup>2</sup>);</p>
<p><strong>m</strong><strong><sup>T</sup></strong> – вязкость газа для типового циклона (m<sup>Т</sup> = 22,2×10<sup>-6</sup> Н×с/м<sup>2</sup>);</p>
<p><strong>W</strong> – действительная скорость газа, м/с (W = 1,65 м/с);</p>
<p><strong>W<sup>T</sup></strong> – действительная скорость газа в типовом циклоне (W<sup>T</sup> = 3.5 м/с).</p>
<p> <img style="display: block; margin-left: auto; margin-right: auto;" src="/images/prakt/kip/6.png" alt="" /></p>
<p> Далее определяем параметр X по следующей формуле:</p>
<p> <img style="display: block; margin-left: auto; margin-right: auto;" src="/images/prakt/kip/7.png" alt="" /></p>
<p> </p>
<p>где <strong>d<sub>m</sub></strong> <strong>= 8 мкм</strong> и <strong>lg</strong> <strong>s</strong><strong><sub>m</sub></strong> <strong>= 0,4</strong> – дисперсный состав пыли;</p>
<p><strong>lg</strong> <strong>s</strong><strong> = 0,308</strong> – дисперсный состав пыли для данного типа циклона (см. табл. 2).</p>
<p> <img style="display: block; margin-left: auto; margin-right: auto;" src="/images/prakt/kip/8.png" alt="" /></p>
<p>По значению параметра <strong>x</strong> определяют значение нормальной функции распределения Ф(x) = 0.875</p>
<p>Эффективность очистки газов в циклоне оценивается по следующей формуле:</p>
<p> <img style="display: block; margin-left: auto; margin-right: auto;" src="/images/prakt/kip/9.png" alt="" /></p>
<p>где <strong>h</strong>           – эффективности очистки;</p>
<p><strong>Ф(</strong><strong>x</strong><strong>)</strong> – значение нормальной функции распределения параметра X.</p>
<p> <img style="display: block; margin-left: auto; margin-right: auto;" src="/images/prakt/kip/10.png" alt="" /></p>
<p>Эффективность очистки газов составляет η = 94%.</p>
<p> </p>
<p><strong>Список использованных источников</strong></p>
<ol>
<li>Белов В.Г., Елманов В.И., Емец В.Н., Савкин В.П. Защите, атмосферы от промышленных загрязнений. Часть I. – Методические указания по выполнению раздела «Охрана природа» в дипломных работах, М., 1986 г.</li>
<li>Справочник по пыле- и золоулавливанию. Под общей ред. А.А. Русанова, М., «Энергия», 1975 г.</li>
<li>Справочник. Средства, защиты в машиностроении. Под общей ред. С.В. Белова, М., «Машиностроение», 1989 г.</li>
</ol>    </div>
...
<nav class="pagenavigation" aria-label="Навигация по страницам">
    <span class="pagination ms-0">
                <a class="btn btn-sm btn-secondary previous" href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no1" rel="prev">
            <span class="visually-hidden">
                Предыдущий: Практическая работа №1            </span>
            <span class="icon-chevron-left" aria-hidden="true"></span> <span aria-hidden="true">Назад</span>            </a>
                    <a class="btn btn-sm btn-secondary next" href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no3" rel="next">
            <span class="visually-hidden">
                Следующий: Практическая работа №3            </span>
...
<script type="text/javascript">   function cookiehintsubmitnoc(obj) {     if (confirm("A refusal will affect the functions of the website. Do you really want to decline?")) {       document.cookie = 'reDimCookieHint=-1; expires=0; path=/';       cookiehintfadeOut(document.getElementById('redim-cookiehint-bottom'));       return true;     } else {       return false;     }   } </script> <div id="redim-cookiehint-bottom">   <div id="redim-cookiehint">     <div class="cookiehead">       <span class="headline">Мы используем файлы cookie</span>     </div>     <div class="cookiecontent">   Мы используем файлы cookie для улучшения вашего взаимодействия на нашем веб-сайте. Просматривая этот веб-сайт, вы соглашаетесь на использование нами файлов cookie.    </div>     <div class="cookiebuttons">       <a id="cookiehintsubmit" onclick="return cookiehintsubmit(this);" href="https://xn--80aabgi1b2am.xn--p1ai/index.php/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no2?ysclid=mnkrait826801664698&amp;rCH=2"         class="btn">Принять</a>           <a id="cookiehintsubmitno" onclick="return cookiehintsubmitnoc(this);" href="https://xn--80aabgi1b2am.xn--p1ai/index.php/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no2?ysclid=mnkrait826801664698&amp;rCH=-2"           class="btn">Отклонить</a>          <div class="text-center" id="cookiehintinfo">              <a target="_self" href="https://бардаков.рф/private">Политика в отношении обработки персональных данных</a>                     </div>      </div>     <div class="clr"></div>   </div> </div>     <script type="text/javascript">        if (!navigator.cookieEnabled) {         document.addEventListener("DOMContentLoaded", function (event) {           document.getElementById('redim-cookiehint-bottom').remove();         });       }        function cookiehintfadeOut(el) {         el.style.opacity = 1;         (function fade() {           if ((el.style.opacity -= .1) < 0) {             el.style.display = "none";           } else {             requestAnimationFrame(fade);           }         })();       }             function cookiehintsubmit(obj) {         document.cookie = 'reDimCookieHint=1; expires=Sun, 04 Apr 2027 23:59:59 GMT;; path=/';         cookiehintfadeOut(document.getElementById('redim-cookiehint-bottom'));         return true;       }        function cookiehintsubmitno(obj) {         document.cookie = 'reDimCookieHint=-1; expires=0; path=/';         cookiehintfadeOut(document.getElementById('redim-cookiehint-bottom'));         return true;       }     </script>     
</body>
</html>
";s:7:"headers";a:9:{i:0;a:2:{s:4:"name";s:15:"x-frame-options";s:5:"value";s:10:"SAMEORIGIN";}i:1;a:2:{s:4:"name";s:15:"referrer-policy";s:5:"value";s:31:"strict-origin-when-cross-origin";}i:2;a:2:{s:4:"name";s:26:"cross-origin-opener-policy";s:5:"value";s:11:"same-origin";}i:3;a:2:{s:4:"name";s:12:"Content-Type";s:5:"value";s:24:"text/html; charset=utf-8";}i:4;a:2:{s:4:"name";s:7:"Expires";s:5:"value";s:29:"Wed, 17 Aug 2005 00:00:00 GMT";}i:5;a:2:{s:4:"name";s:13:"Last-Modified";s:5:"value";s:29:"Sat, 04 Apr 2026 19:59:30 GMT";}i:6;a:2:{s:4:"name";s:13:"Cache-Control";s:5:"value";s:62:"no-store, no-cache, must-revalidate, post-check=0, pre-check=0";}i:7;a:2:{s:4:"name";s:6:"Pragma";s:5:"value";s:8:"no-cache";}i:8;a:2:{s:4:"name";s:6:"Status";s:5:"value";s:3:"200";}}}