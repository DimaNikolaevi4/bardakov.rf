<?php die("Access Denied"); ?>#x#a:2:{s:4:"body";s:95724:"                    <!DOCTYPE html>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<title>Лекции</title>
	<link href="/obuchenie/pm02/lektsii?format=feed&amp;type=rss" rel="alternate" type="application/rss+xml" title="Лекции">
	<link href="/obuchenie/pm02/lektsii?format=feed&amp;type=atom" rel="alternate" type="application/atom+xml" title="Лекции">
	...
	<link href="/templates/rt_elixir/custom/css-compiled/elixir_20.css?69dbf130" rel="stylesheet">
	<link href="/media/gantry5/engines/nucleus/css-compiled/bootstrap5.css" rel="stylesheet">
	<link href="/media/system/css/joomla-fontawesome.min.css" rel="stylesheet">
	<link href="/media/plg_system_debug/css/debug.css" rel="stylesheet">
	<link href="/media/gantry5/assets/css/font-awesome6-pseudo.min.css" rel="stylesheet">
	<link href="/templates/rt_elixir/custom/css-compiled/elixir-joomla_20.css?69dbf131" rel="stylesheet">
...
<!-- /Yandex.Metrika counter -->
<link rel="canonical" href="https://бардаков.рф/index.php/obuchenie/pm02/lektsii" />
</head>


    <body class="gantry site com_content view-category layout-blog no-task dir-ltr itemid-167 outline-20 g-offcanvas-left g-default g-style-preset3">
    ...
    <form class="mod-finder js-finder-searchform form-search" action="/search" method="get" aria-label="search">
        ...
        Лекции    </h1>
            ...
            <div class="category-desc clearfix">
                            <img src="/images/pm02/headers/lekcii.png" alt="Лекция" width="960" height="636" loading="lazy">                                                        </div>
...
<p>Приемка объекта оформляется актом готовности объекта к производству работ по монтажу систем автоматизации.</p>
            ...
            <div class="com-content-category-blog__children cat-children">
                            <h3> Подкатегории </h3>
                                ...
                                <h3 class="page-header item-title"><a href="/obuchenie/pm02/lektsii/razdel-1">
                    Раздел 1</a>
                    
                                            <a href="#category-15" data-bs-toggle="collapse" class="btn btn-sm float-end" aria-label="Показать больше категорий"><span class="icon-plus" aria-hidden="true"></span></a>
                                    </h3>
                
                                                        <div class="com-content-category-blog__description category-desc">
                        <p align="justify">Монтаж приборов и систем автоматизации осуществляют в соответствии с проектом, техническими условиями, инструкциями заводов-изготовителей и условиями эксплуатации. Места установки приборов, аппаратуры и запорной арматуры (кланов, вентилей, переключателей) должны быть доступны и удобны для обслуживания, а также хорошо освещены. В труднодоступных местах для удобства обслуживания приборов и аппаратуры проектом должны быть предусмотрены, а строительной организацией установлены лестницы, площадки и т. п.</p>
<p align="justify">Во избежание повреждения приборы и аппаратуру не допускается устанавливать: в помещениях с незаконченными строительными и отделочными работами, а также до окончания работ по монтажу технологического оборудования; в местах, подверженных вибрации; в -условиях агрессивных сред и местах с повышенной влажностью; в местах с сильным магнитным полем.</p>
<p align="justify">Крепят приборы и аппаратуру на несущих конструкциях (стативах, щитах, металлоконструкциях) крепежными изделиями, не имеющими сорванных резьб, шлицев и граней. Все резьбовые соединения должны быть туго затянуты. При необходимости установки приборов и аппаратуры в местах, подверженных вибрации, принимают меры к ее полному устранению или к изменению частоты и амплитуды колебаний до значений, обеспечивающих нормальную работу приборов (путем установки последних- на амортизаторах) и прочность их крепления. В последнем случае резьбовые соединения должны иметь пружинные шайбы, шплинты или контргайки, исключающие их самопроизвольное отвинчивание.</p>                    </div>
                                    
                                <div class="com-content-category-blog__children collapse fade" id="category-15">
                                                                <div class="com-content-category-blog__child">
                                <h3 class="page-header item-title"><a href="/obuchenie/pm02/lektsii/razdel-1/tema-1-1-organizatsiya-rabot-po-montazhu-sistem-avtomatizatsii">
                    Тема 1.1 Организация работ по монтажу систем автоматизации </a>
