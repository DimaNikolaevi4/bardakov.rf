<?php die("Access Denied"); ?>#x#a:2:{s:4:"body";s:79137:"                    <!DOCTYPE html>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<link href="/templates/rt_elixir/custom/css-compiled/elixir_26.css?69b32fe3" rel="stylesheet">
	<link href="/media/gantry5/engines/nucleus/css-compiled/bootstrap5.css" rel="stylesheet">
	<link href="/media/system/css/joomla-fontawesome.min.css" rel="stylesheet">
	<link href="/media/plg_system_debug/css/debug.css" rel="stylesheet">
	<link href="/media/gantry5/assets/css/font-awesome6-pseudo.min.css" rel="stylesheet">
	<link href="/templates/rt_elixir/custom/css-compiled/elixir-joomla_26.css?69b32fe4" rel="stylesheet">
	...
	<script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base","name":"Преподаватель Бардаков","url":"https://xn--80aabgi1b2am.xn--p1ai/"},{"@type":"WebSite","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebSite/base","url":"https://xn--80aabgi1b2am.xn--p1ai/","name":"Преподаватель Бардаков","publisher":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base"},"potentialAction":{"@type":"SearchAction","target":"https://xn--80aabgi1b2am.xn--p1ai/search?q={search_term_string}","query-input":"required name=search_term_string"}},{"@type":"WebPage","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebPage/base","url":"https://xn--80aabgi1b2am.xn--p1ai/index.php/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no1?highlight=WzZd","name":"Практическая работа №1","isPartOf":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebSite/base"},"about":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base"},"inLanguage":"ru-RU"},{"@type":"Article","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/com_content/article/42","name":"Практическая работа №1","headline":"Практическая работа №1","inLanguage":"ru-RU","author":{"@type":"Person","name":"Бардаков Дмитрий Николаевич"},"isPartOf":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebPage/base"}}]}</script>
...
<!-- /Yandex.Metrika counter -->
<link rel="canonical" href="https://бардаков.рф/index.php/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no1?highlight=WzZd" />
</head>
...
<div id="system-message-container">
    ...
    <span class="icon-user icon-fw" aria-hidden="true"></span>
        ...
        <p><strong>Тема: </strong>Расчет защитного заземления в цехах с электроустановками напряжением до 1000 В.</p>
<p><strong>Цель работы:</strong> Ознакомиться с расчетом защитного заземления в цехах с электроустановками напряжением до 1000 В.</p>
 
<p>ОБЩИЕ СВЕДЕНИЯ</p>
<p>Защитное заземляющее устройство, предназначенное для защиты людей от поражения электрическим током при переходе напряжения на металлические части электрооборудования, представляет собой специально выполненное соединение конструктивных металлических частей электрооборудования (вычислительная техника, приборостроительные комплексы, испытательные стенды, станки, аппараты, светильники, щиты управления, шкафы и пр.), нормально не находящихся под напряжением, с заземлителями, расположенными непосредственно в земле.</p>
<p>В качестве искусственных заземлителей используют стальные трубы длиной 1,5…4 м, диаметром 25…50 мм, которые забивают в землю, а также металлические стержни и полосы. Для достижения требуемого сопротивления заземлителя, как правило, используют несколько труб (стержней), забитых в землю и соединённых там металлической (стальной) полосой.</p>
<p>На электрических установках напряжением до 1000В одиночные заземлители соединяют стальной полосой толщиной не менее 4мм и сечением не менее 48мм<sup>2</sup>. Для уменьшения экранирования рекомендуется одиночные заземлители располагать на расстоянии не менее 2,5…3 м один от другого.</p>
<p>Контурным защитным заземлением называется система, состоящая из труб, забиваемых вокруг здания цеха, в котором расположены электроустановки.</p>
<p>Заземление электроустановок необходимо выполнять:</p>
<ul style="list-style-type: circle;">
<li>
<p>при напряжении выше 380В переменного и 440В постоянного тока в помещениях без повышенной опасности, т. е. во всех случаях;</p>
</li>
<li>
<p>при номинальном напряжении выше 42В переменного и 110В постоянного тока в помещениях с повышенной опасностью, особо опасных и в наружных установках;</p>
</li>
<li>
<p>при любых напряжениях переменного и постоянного тока во взрывоопасных помещениях.</p>
</li>
</ul>
<p>МЕТОДИКА РАСЧЕТА</p>
<p>Сопротивление растеканию тока, Ом, через одиночный заземлитель из труб диаметром</p>
<p>25…50 мм.</p>
<p><strong>Rтр = 0,9 ·(ρ/lтр), (1.1)</strong></p>
<p>где ρ - удельное сопротивление грунта, которые выбирают в зависимости от его вида (суглинок, глина, песок), Омсм; lтр – длина трубы, м.</p>
<p>Затем определяют ориентировочное число вертикальных заземлителей без учёта коэффициента экранирования</p>
<p><strong>n = Rтр /r, (1.2)</strong></p>
<p>где r – допустимое сопротивление заземляющего устройства, Ом.</p>
<p>В соответствии с Правилами устройства электроустановок (ПЭУ) на электрических установках напряжением до 1000В допустимое сопротивление заземляющего устройства равно не более 4 Ом.</p>
<p>Разместив вертикальные заземлители на плане и определив расстояние между ними, определяют коэффициент экранирования заземлителей по табл. 1.1.</p>
<h4>Коэффициенты экранирования заземлителей η<sub>гр</sub></h4>
<h4>Таблица 1.1</h4>
<table cellspacing="0">
<tbody>
<tr>
<td style="text-align: center;">
<p style="text-align: center;">Число труб (угол- ков)</p>
</td>
<td style="text-align: center;">
<p>Отношение расстояния между трубами (уголками) к их длине</p>
</td>
<td style="text-align: center;">
<p>η<sub>гр</sub></p>
</td>
...
<p> </p>
<p>Число вертикальных заземлителей с учётом коэффициента экранирования</p>
<p>n1 = n / η<sub>тр</sub> (1.3)</p>
<p>Длина соединительной полосы, м,</p>
<p>lп = n1 ·a, (1.4)</p>
<p>где а – расстояние между заземлителями, м.</p>
<p>Если расчётная длина соединительной полосы получилась меньше периметра цеха (задаётся по варианту), то длину соединительной полосы необходимо принять равной периметру цеха плюс 12…16 м. После этого следует уточнить значение  η<sub>тр</sub>. </p>
<p>Если а/l<sub>тр</sub> &gt;3, принимают η<sub>тр</sub> = 1.</p>
<p>Сопротивление растеканию электрического тока через соединительную полосу, Ом.</p>
<p>Rn = 2,1· (p / l n) (1.5)</p>
<p>Результирующее сопротивление растеканию тока всего заземляющего устройства, Ом.</p>
<p>Rз = Rтр ·Rn / (η<sub>n</sub> ·Rтр + η<sub>тр</sub> ·Rn·n1), (1.6)</p>
<p>где η<sub>n</sub> – коэффициент экранирования соединительной полосы (табл. 1.2)</p>
<h4>Таблица 1.2</h4>
<h4>Коэффициенты экранирования соединительной полосы</h4>
<table cellspacing="0">
<tbody>
<tr>
<td style="text-align: center;" rowspan="2">
<p style="text-align: center;">Отношение расстояния между заземлителями к их длине</p>
</td>
...
<h4>Полученное результирующее сопротивление растеканию тока всего заземляющего устройства сравнивают с допустимым (не более 4 Ом).</h4>
<p>На плане цеха размещают вертикальные заземлители и соединительную полосу.</p>
<p><strong>ПОРЯДОК ВЫПОЛНЕНИЯ ЗАДАНИЯ</strong></p>
<ol>
<li>
<p>Выбрать вариант (табл. 1.3.).</p>
</li>
<li>
<p>Рассчитать результирующее сопротивление растеканию тока заземляющего устройства и сравнить с допустимым сопротивлением.</p>
</li>
<li>
<p>На плане цеха размещают вертикальные заземлители и соединительную полосу (рис. 1).</p>
</li>
</ol>
<h4>ВАРИАНТЫ ЗАДАНИЙ К РАБОТЕ ПО ТЕМЕ:</h4>
<h4>Таблица 1.3.</h4>
<h4>«Расчёт контурного защитного заземления в цехах с электроустановками напряжением до 1000 В»</h4>
<table cellspacing="0">
<tbody>
<tr>
<td style="text-align: center;" rowspan="2">
<p style="text-align: center;">Вариант</p>
</td>
<td style="text-align: center;" colspan="2">
<p>Габаритные размеры цеха, м</p>
</td>
...
<td style="text-align: center;" rowspan="2">
<p>Уд. сопротивление грунта, Ом · см</p>
</td>
</tr>
<tr>
<td style="text-align: center;">
...
<p> </p>
<p>ПРИМЕР ВЫПОЛНЕНИЯ РАБОТЫ «Расчёт контурного защитного заземления в цехах с электроустановками напряжением до 1000 в»</p>
<h4>1. Исходные данные:</h4>
<table cellspacing="0">
<tbody>
<tr>
<td style="text-align: center;" rowspan="2">
...
<td style="text-align: center;" rowspan="2">
<p> </p>
<p>Удельное сопротивление грунта, Ом· см</p>
</td>
</tr>
<tr>
<td style="text-align: center;">
...
<h4>Цель работы: рассчитать результирующее сопротивление растеканию тока заземляющего устройства и сравнить с допустимым сопротивлением.</h4>
<h4>Ход работы:</h4>
<ol>
<li style="list-style-type: none;">
<ol>
<li>
<p>Сопротивление растеканию тока, через одиночный заземлитель диаметром 25...30 мм</p>
<p>рассчитаем по формуле (1.1)</p>
<p>Rтр = 0,9 (ρ/l<sub>тp</sub>),</p>
<p>где ρ  – удельное сопротивление грунта, Lmp – длина трубы, 1,5…4м. Принимаем Lmp = 2,75 м.</p>
<p>В нашем случае:</p>
<p>Rтр = 0,9 · (420 / 2,75) = 137,5 (Ом).</p>
</li>
<li>
<p>Определяем примерное число заземлителей без учёта коэффициента экранирования по формуле (1.2.):</p>
<p>n = Rтр / r,</p>
<p>где r – допустимое сопротивление заземляющего устройства, 4 Ом. В нашем случае:</p>
<p>n = 137,5 / 4 = 34,4 (шт).</p>
</li>
<li>
<p>Определяем коэффициент экранирования заземлителей:</p>
<ul id="l7">
<li>
<p>расстояние между трубами 2,5…3м – принимаем 2,75м,</p>
</li>
<li>
<p>длина труб – 2,75м,</p>
</li>
<li>
<p>отношение расстояния к длине – 1,</p>
</li>
<li>
<p>число труб – 34,4 ≈ 40 (шт). По табл. 1.1. выбираем η<sub>тр</sub>:</p>
</li>
</ul>
<p>η<sub>тр</sub> = 0,38…0,44</p>
</li>
<li>
<p>Число вертикальных заземлителей с учётом коэффициента экранирования определяем по формуле (1.3):</p>
<p>n1 = n/η<sub>тр</sub></p>
<p>В нашем случае:</p>
<p>n1 = 34,4/0,38 = 90,4 (шт).</p>
</li>
<li>
<p>Длину соединительной полосы определяем по формуле (1.4):</p>
<p>ln = n1·a = 90,4·2,75 = 248,7 (м),</p>
<p>где а – расстояние между заземлителями; Периметр цеха p ,м:</p>
<p>р = (а + в)·2 = (72 + 18)·2 = 180 (м).</p>
<p>Расчетная длина соединительной полосы не менее периметра цеха.</p>
</li>
<li>
<p>Сопротивление растеканию электрического тока через соединительную полосу,</p>
<p>Ом, определяем по формуле (1.5):</p>
<p>Rn = 2,1· (p / l n)</p>
<p>В нашем случае: Rn = 2,1( 420/248,7)=3,55</p>
</li>
<li>
<p>Результирующее сопротивление растеканию тока всего заземляющего устройства, Ом, определяем по формуле (1.6):</p>
<p>Rз =(Rтр ·Rn)/ (η<sub>n</sub> ·Rтр + η<sub>тр</sub> ·Rn·n1) (Ом)</p>
<p>где η<sub>n</sub> – коэффициент экранирования соединительной полосы, η<sub>n</sub> = 0,21.</p>
<p>В нашем случае:</p>
<p>Rз=(137,5·3,5)/(0,21·137,5+0,38·3,5·90,4)=3,2 (Ом)</p>
<p>Вывод: допустимое сопротивление заземляющего устройства на электрических установках напряжением до 1000 В равно 3,2 Ом, что не более 4 Ом. Следовательно, полученное результирующее сопротивление растеканию тока заземляющего устройства соответствует норме и заземлители установлены правильно.</p>
<p> </p>
<p>ЛИТЕРАТУРА</p>
<ol>
<li>
<p>Безопасность жизнедеятельности / С.В, Белов, В.А. Девисилов, А.Ф. Козьяков и др.; Под общ. Ред. С.В. Белова. – М.: Высшая школа, НМЦ СПО, 2014. – 343 с.</p>
</li>
<li>
<p>Королькова В.И. Электробезопасность на промышленных предприятиях. – М.: Машиностроение, 1971.</p>
</li>
</ol>
</li>
</ol>
...
<p><img style="display: block; margin-left: auto; margin-right: auto;" src="https://бардаков.рф/images/zazemlenie/Image_005.png" alt="image" width="280" height="219"></p>
<p style="text-align: center;">Рис. 1. Схема устройства искусственного группового заземления:</p>    </div>

        
        
<nav class="pagenavigation" aria-label="Навигация по страницам">
    <span class="pagination ms-0">
                    <a class="btn btn-sm btn-secondary next" href="/obuchenie/kip/prakticheskie-kip/prakticheskaya-rabota-no2" rel="next">
            <span class="visually-hidden">
                Следующий: Практическая работа №2            </span>
