<?php die("Access Denied"); ?>#x#a:2:{s:4:"body";s:64151:"                            <!DOCTYPE html>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<title>13.01.10 Электромонтер по ремонту и обслуживанию электрооборудования (по отраслям)</title>
	...
	<link href="/templates/rt_elixir/custom/css-compiled/elixir_20.css?6a0d71f0" rel="stylesheet">
	<link href="/media/gantry5/engines/nucleus/css-compiled/bootstrap5.css" rel="stylesheet">
	<link href="/media/system/css/joomla-fontawesome.min.css" rel="stylesheet">
	<link href="/media/plg_system_debug/css/debug.css" rel="stylesheet">
	<link href="/media/gantry5/assets/css/font-awesome6-pseudo.min.css" rel="stylesheet">
	<link href="/templates/rt_elixir/custom/css-compiled/elixir-joomla_20.css?6a0d71f1" rel="stylesheet">
	...
	<script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base","name":"Преподаватель Бардаков","url":"https://xn--80aabgi1b2am.xn--p1ai/"},{"@type":"WebSite","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebSite/base","url":"https://xn--80aabgi1b2am.xn--p1ai/","name":"Преподаватель Бардаков","publisher":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base"},"potentialAction":{"@type":"SearchAction","target":"https://xn--80aabgi1b2am.xn--p1ai/search?q={search_term_string}","query-input":"required name=search_term_string"}},{"@type":"WebPage","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebPage/base","url":"https://xn--80aabgi1b2am.xn--p1ai/abiturientu/professii/13-01-10-elektromonter-po-remontu-i-obsluzhivaniyu-elektrooborudovaniya-po-otraslyam","name":"13.01.10 Электромонтер по ремонту и обслуживанию электрооборудования (по отраслям)","isPartOf":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebSite/base"},"about":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/Organization/base"},"inLanguage":"ru-RU"},{"@type":"Article","@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/com_content/article/17","name":"13.01.10 Электромонтер по ремонту и обслуживанию электрооборудования (по отраслям)","headline":"13.01.10 Электромонтер по ремонту и обслуживанию электрооборудования (по отраслям)","inLanguage":"ru-RU","isPartOf":{"@id":"https://xn--80aabgi1b2am.xn--p1ai/#/schema/WebPage/base"}}]}</script>
...
<!-- /Yandex.Metrika counter -->
<link rel="canonical" href="https://бардаков.рф/abiturientu/professii/13-01-10-elektromonter-po-remontu-i-obsluzhivaniyu-elektrooborudovaniya-po-otraslyam" />
</head>


    <body class="gantry site com_content view-article no-layout no-task dir-ltr itemid-144 outline-20 g-offcanvas-left g-default g-style-preset3">
...
<li><strong>Будущая квалификация:</strong>    Электромонтер по ремонту и обслуживанию электрооборудования</li>
<li><strong>Будущие профессии: </strong>Электромонтер по ремонту и обслуживанию электрооборудования<strong> </strong></li>
</ul>
<h4 style="text-align: center;"><strong>Чему научат?</strong></h4>
<ul>
<li>Сборке, монтажу, регулировке и ремонту узлов и механизмов оборудования, агрегатов, машин, станков и другого электрооборудования промышленных организаций.</li>
<li>Проверке и наладке электрооборудования.</li>
<li>Устранению и предупреждению аварий и неполадок электрооборудования.</li>
</ul>     </div>
...
<div class="g-simplecontent-item-main-content">Электротехника | Техническое черчение | Основы слесарно-сборочных и электромонтажных работ | Организация работ по сборке, монтажу и ремонту электрооборудования промышленных организаций | Организация и технология проверки электрооборудования | Контрольно-измерительные приборы | Организация технического обслуживания электрооборудования промышленных организаций</div>
</div>
<div class="g-simplecontent-item g-simplecontent-layout-standard">
<h4 class="g-simplecontent-item-content-title">Практика студентов</h4>
<div class="g-simplecontent-item-main-content">Учебная и производственная практики являются обязательной частью образовательной программы. Производственная практика проходит в два этапа: производственная практика и преддипломная практика. Как правило, практики организуются на предприятиях различных отраслей промышленности</div>
</div>
<div class="g-simplecontent-item g-simplecontent-layout-standard">
<h4 class="g-simplecontent-item-content-title">Итоговая аттестация студентов</h4>
<div class="g-simplecontent-item-main-content">Государственная итоговая аттестация включает защиту выпускной квалификационной работы (выпускная практическая квалификационная работа и письменная экзаменационная работа)</div>
</div>
