...
return [
    ...
    'filename' => '/home/m/mitiba/bardakov.rf/public_html/templates/rt_elixir/particles/slideshow.yaml',
    'modified' => 1666521226,
    'data' => [
        'name' => 'Slideshow',
                        ...
                        '_tab_settings' => [
                            ...
                            'fields' => [
                                ...
                                'direction' => [
                                    ...
                                    'description' => 'Horizontal or vertical direction.',
                                    'default' => 'horizontal',
                                    'options' => [
                                ...
                                'bullets' => [
                                    'type' => 'select.select',
                                    'label' => 'Bullets',
                                    'description' => 'Enable or disable the navigation bullets.',
                                    'default' => 'enabled',
                                    'options' => [
                                        'enabled' => 'Enable',
                                        'disabled' => 'Disable'
                                ...
                                'arrows' => [
                                    'type' => 'select.select',
                                    'label' => 'Arrows',
                                    'description' => 'Enable or disable the arrows navigation.',
                                    'default' => 'enabled',
                                    'options' => [
                                        'enabled' => 'Enable',
                                        'disabled' => 'Disable'
                                ...
                                'items' => [
                                    ...
                                    'fields' => [
                                        ...
                                        '.image' => [
                                            ...
                                            'description' => 'Select background image for slideshow',
